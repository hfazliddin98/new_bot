...
class CreateKitchenStaffForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        try:
            ...
            # Agar bu User uchun allaqachon KitchenStaff mavjud bo'lsa, xato
            try:
                if hasattr(user, 'kitchenstaff') and user.kitchenstaff:
                    if user and hasattr(user, 'id') and user.id:
                        try:
                            user.delete()
                        except:
                            pass
                    raise forms.ValidationError("Bu foydalanuvchi uchun allaqachon oshpaz ma'lumoti mavjud")
...
class CreateCourierStaffForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        try:
            ...
            # Agar bu User uchun allaqachon CourierStaff mavjud bo'lsa, xato
            try:
                if hasattr(user, 'courierstaff') and user.courierstaff:
                    if user and hasattr(user, 'id') and user.id:
                        try:
                            user.delete()
                        except:
                            pass
                    raise forms.ValidationError("Bu foydalanuvchi uchun allaqachon kuryer ma'lumoti mavjud")
